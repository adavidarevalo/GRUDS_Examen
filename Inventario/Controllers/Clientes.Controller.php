...
switch ($_GET["op"]) {
    ...
    case 'insertar':
        ...
        $datos = array(); //defino un arreglo
        $datos = $clientes->insertar($Nombre, $Correo, $Telefono); //llamo al modelo de usuarios e invoco al procedimiento insertar
    ...
    case 'actualizar':
        ...
        $Telefono = $_POST["Telefono"];
        $datos = array(); //defino un arreglo
        $datos = $clientes->actualizar($ID_cliente, $Nombre, $Correo, $Telefono); //llamo al modelo de usuarios e invoco al procedimiento actual
        echo json_encode($datos); //devuelvo el arreglo en formato json
        break;
